...
Autoregressive Chain-of-Thought (CoT)
Standard transformer reasoning using step-by-step prompts.

Iterative Prompting
Autoregressive reasoning with additional self-reflection and revision steps.

Diffusion-Based Reasoning
Reasoning generated through a diffusion–transformer hybrid model using iterative denoising.
